...
return [
    ...
    "layout" => [
        ...
        "data" => [
            ...
            "stylesheets" => [
                ...
                "css/darkAndBlueWithDesignelement.min.css",
            ],
            "javascripts" => [
    ...
    "views" => [
        [
            ...
            "data" => [
                "class" => "large",
                "siteLogo"      => "image/theme/blueHeather256x256.jpg",
                "siteLogoAlt"   => "Image of blueHeather",
            ],
        ],
        [
            "region" => "header-col-1",
            ...
            "data" => [
                "homeLink"      => "",
                "siteLogoText"  => "oophp",
                "siteLogoTextIcon" => "image/theme/blueHeather40x40.jpg",
                "siteLogoTextIconAlt" => "Image of blueHeather",
            ],
        ],
        [
            "region" => "header-col-2",
